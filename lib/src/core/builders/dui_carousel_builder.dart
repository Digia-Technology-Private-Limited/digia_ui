import 'package:digia_ui/src/components/carousel/carousel.dart';
...
class DUICarouselBuilder extends DUIWidgetBuilder {
  DUICarouselBuilder(DUIWidgetJsonData data, DUIWidgetRegistry? registry) : super(data: data, registry: registry);

  static DUICarouselBuilder create(DUIWidgetJsonData data, {DUIWidgetRegistry? registry}) {
