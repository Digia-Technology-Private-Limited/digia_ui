...
class DUIImageProps {
  ...
  DUIImageProps(
      {this.styleClass, required this.imageSrc, this.placeHolder, this.errorImage, this.aspectRatio, this.fit});

  factory DUIImageProps.fromJson(Map<String, dynamic> json) => _$DUIImagePropsFromJson(json);
